...
void setup_textures()
{
    ...
    unsigned char* data = stbi_load(std::experimental::filesystem::path("/wall.jpg"), &width, &height, &nrChannels, 0);
    if (data)
    {
...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Simple Triangle", NULL, NULL);
    if (window == NULL)
    {
